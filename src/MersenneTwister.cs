// File contents downloaded from http://takel.jp/mt/MersenneTwister.cs
// on 2005 March 9.  Only local change is the addition of the keyword
// "override" to the Next(int, int) method.
