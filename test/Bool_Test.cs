...
namespace Edu.Wisc.Forest.Flel.Test.Util
{
    ...
    public class Bool_Test
    {
        ...
        public void Parse_Bad1()
        {
            Parse_PrintException("ye");
        }
        ...
        [Test]
        [ExpectedException(typeof(System.ApplicationException))]
        public void Parse_Bad2()
        {
            Parse_PrintException("-+");
        }
        ...
        [Test]
        [ExpectedException(typeof(System.ApplicationException))]
        public void Parse_Bad3()
        {
            Parse_PrintException(null);
        }
